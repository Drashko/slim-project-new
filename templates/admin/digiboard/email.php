...
<head>
    ...
    <link rel="stylesheet" href="/digiboard/assets/vendor/css/jquery.dataTables.min.css">
...
<body class="body-padding body-p-top light-theme">
        ...
        <div class="email-panel d-flex rounded">
                        ...
                        <div class="emial-menu-list">
                            <div class="scrollable">
                                <ul class="nav" role="tablist">
                                    <li>
                                        <button class="btn-flush active" id="nav-inbox-tab" data-bs-toggle="tab" data-bs-target="#nav-inbox" type="button" role="tab" aria-controls="nav-inbox" aria-selected="true">
                                            <span class="badge bg-danger">9+</span>
                                    ...
                                    <li>
                                        <button class="btn-flush" id="nav-starred-tab" data-bs-toggle="tab" data-bs-target="#nav-starred" type="button" role="tab" aria-controls="nav-starred" aria-selected="false">
                                            <span class="part-icon"><i class="fa-light fa-star"></i></span>
                                            <span class="part-txt">Starred</span>
                                        </button>
                                    </li>
                                    <li>
                                        <button class="btn-flush" id="nav-trash-tab" data-bs-toggle="tab" data-bs-target="#nav-trash" type="button" role="tab" aria-controls="nav-trash" aria-selected="false">
                                            <span class="part-icon"><i class="fa-light fa-trash-can"></i></span>
                                            <span class="part-txt">Trash</span>
                                        </button>
                                    </li>
                                    <li>
                                        <button class="btn-flush" id="nav-sent-tab" data-bs-toggle="tab" data-bs-target="#nav-sent" type="button" role="tab" aria-controls="nav-sent" aria-selected="false">
                                            <span class="part-icon"><i class="fa-light fa-paper-plane-top"></i></span>
                                            <span class="part-txt">Sent</span>
                                        </button>
                                    </li>
                                    <li>
                                        <button class="btn-flush" id="nav-draft-tab" data-bs-toggle="tab" data-bs-target="#nav-draft" type="button" role="tab" aria-controls="nav-draft" aria-selected="false">
                                            <span class="part-icon"><i class="fa-light fa-file"></i></span>
                                            <span class="part-txt">Draft</span>
                                        </button>
                                    </li>
                                    <li>
                                        <button class="btn-flush" id="nav-all-mail-tab" data-bs-toggle="tab" data-bs-target="#nav-all-mail" type="button" role="tab" aria-controls="nav-all-mail" aria-selected="false">
                                            <span class="part-icon"><i class="fa-light fa-envelopes"></i></span>
                                            <span class="part-txt">All Email</span>
                                        </button>
                                    </li>
                                    <li>
                                        <button class="btn-flush" id="nav-spam-tab" data-bs-toggle="tab" data-bs-target="#nav-spam" type="button" role="tab" aria-controls="nav-spam" aria-selected="false">
                                            <span class="part-icon"><i class="fa-light fa-hexagon-exclamation"></i></span>
                                            <span class="part-txt">Spam</span>
                                        </button>
                                    </li>
                                    <li>
                                        <button class="btn-flush" id="nav-important-tab" data-bs-toggle="tab" data-bs-target="#nav-important" type="button" role="tab" aria-controls="nav-important" aria-selected="false">
                                            <span class="part-icon"><i class="fa-light fa-ribbon"></i></span>
                                            <span class="part-txt">Important</span>
                                        </button>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="panel rounded-0">
                <div class="tab-content">
                            ...
                            <div class="tab-content email-tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-primary" role="tabpanel" aria-labelledby="nav-primary-tab" tabindex="0">
                                    <div class="table-wrapper">
                                        ...
                                        <div class="mail-details d-none" data-mail-tab="nav-primary">
                                ...
                                <div class="tab-pane fade" id="nav-promotion" role="tabpanel" aria-labelledby="nav-promotion-tab" tabindex="0">
                                    <div class="table-wrapper">
                                        ...
                                        <div class="mail-details d-none" data-mail-tab="nav-promotion">
                                            <div class="mail-body-top d-flex justify-content-between align-items-center mb-10">
                                                <div class="left d-flex align-items-center gap-2">
                                                    <button class="btn btn-sm btn-icon btn-outline-danger close-mail"><i class="fa-light fa-xmark"></i></button>
                                                    <span class="badge bg-secondary p-1 rounded">Inbox</span>
                                ...
                                <div class="tab-pane fade" id="nav-social" role="tabpanel" aria-labelledby="nav-social-tab" tabindex="0">
                                    <div class="table-wrapper">
                                        ...
                                        <div class="mail-details d-none" data-mail-tab="nav-social">
                                            <div class="mail-body-top d-flex justify-content-between align-items-center mb-10">
                                                <div class="left d-flex align-items-center gap-2">
                                                    <button class="btn btn-sm btn-icon btn-outline-danger close-mail"><i class="fa-light fa-xmark"></i></button>
                                                    <span class="badge bg-secondary p-1 rounded">Inbox</span>
                                ...
                                <div class="tab-pane fade" id="nav-updates" role="tabpanel" aria-labelledby="nav-updates-tab" tabindex="0">
                                    <div class="table-wrapper">
                                        ...
                                        <div class="mail-details d-none" data-mail-tab="nav-updates">
                                            <div class="mail-body-top d-flex justify-content-between align-items-center mb-10">
                                                <div class="left d-flex align-items-center gap-2">
                                                    <button class="btn btn-sm btn-icon btn-outline-danger close-mail"><i class="fa-light fa-xmark"></i></button>
                                                    <span class="badge bg-secondary p-1 rounded">Inbox</span>
                        ...
                        <div class="panel-body">
                            <div class="product-table-quantity d-flex flex-wrap align-items-center gap-2 mb-20">
                                <ul class="mb-0">
                                    ...
                                    <li>Unread (19)</li>
                                    <li>Draft (05)</li>
                                    <li class="text-white">Trush (05)</li>
                                </ul>
                                <ul class="top-action mb-0 d-none">
                                    <li>|</li>
                                    <li><button class="btn-flush" data-bs-toggle="tooltip" data-bs-title="Move to archive"><i class="fa-light fa-box-archive"></i></button></li>
                            ...
                            <div class="table-wrapper">
                                ...
                                <div class="mail-details d-none" data-mail-tab="nav-trash">
                                    <div class="mail-body-top d-flex justify-content-between align-items-center mb-10">
                                        <div class="left d-flex align-items-center gap-2">
                                            <button class="btn btn-sm btn-icon btn-outline-danger close-mail"><i class="fa-light fa-xmark"></i></button>
                                            <span class="badge bg-secondary p-1 rounded">Inbox</span>
                    ...
                    <div class="tab-pane fade" id="nav-sent" role="tabpanel" aria-labelledby="nav-sent-tab" tabindex="0">
                        <div class="panel-header">
                            <div class="d-flex align-items-center gap-1">
                                <button class="btn btn-sm btn-icon btn-primary mail-menu-btn d-lg-none"><i class="fa-light fa-bars"></i></button>
                                <h5>Sent</h5>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-wrapper">
                                ...
                                <div class="mail-details d-none" data-mail-tab="nav-sent">
                                    <div class="mail-body-top d-flex justify-content-between align-items-center mb-10">
                                        <div class="left d-flex align-items-center gap-2">
                                            <button class="btn btn-sm btn-icon btn-outline-danger close-mail"><i class="fa-light fa-xmark"></i></button>
                                            <span class="badge bg-secondary p-1 rounded">Inbox</span>
                        ...
                        <div class="panel-body">
                            <div class="product-table-quantity d-flex flex-wrap align-items-center gap-2 mb-20">
                                <ul class="mb-0">
                                    <li>All (23)</li>
                                    <li>Unread (19)</li>
                                    <li class="text-white">Draft (05)</li>
                                    <li>Trush (05)</li>
                                </ul>
                                <ul class="top-action mb-0 d-none">
                                    <li>|</li>
                            ...
                            <div class="table-wrapper">
                                ...
                                <div class="mail-details d-none" data-mail-tab="nav-draft">
                                    <div class="mail-body-top d-flex justify-content-between align-items-center mb-10">
                                        <div class="left d-flex align-items-center gap-2">
                                            <button class="btn btn-sm btn-icon btn-outline-danger close-mail"><i class="fa-light fa-xmark"></i></button>
                                            <span class="badge bg-secondary p-1 rounded">Inbox</span>
                    ...
                    <div class="tab-pane fade" id="nav-all-mail" role="tabpanel" aria-labelledby="nav-all-mail-tab" tabindex="0">
                        <div class="panel-header">
                            <div class="d-flex align-items-center gap-1">
                                <button class="btn btn-sm btn-icon btn-primary mail-menu-btn d-lg-none"><i class="fa-light fa-bars"></i></button>
                                <h5>All Mail</h5>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-wrapper">
                                ...
                                <div class="mail-details d-none" data-mail-tab="nav-all-mail">
                                    <div class="mail-body-top d-flex justify-content-between align-items-center mb-10">
                                        <div class="left d-flex align-items-center gap-2">
                                            <button class="btn btn-sm btn-icon btn-outline-danger close-mail"><i class="fa-light fa-xmark"></i></button>
                                            <span class="badge bg-secondary p-1 rounded">Inbox</span>
                    ...
                    <div class="tab-pane fade" id="nav-spam" role="tabpanel" aria-labelledby="nav-spam-tab" tabindex="0">
                        <div class="panel-header">
                            <div class="d-flex align-items-center gap-1">
                                <button class="btn btn-sm btn-icon btn-primary mail-menu-btn d-lg-none"><i class="fa-light fa-bars"></i></button>
                                <h5>Spam</h5>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-wrapper">
                                ...
                                <div class="mail-details d-none" data-mail-tab="nav-spam">
                                    <div class="mail-body-top d-flex justify-content-between align-items-center mb-10">
                                        <div class="left d-flex align-items-center gap-2">
                                            <button class="btn btn-sm btn-icon btn-outline-danger close-mail"><i class="fa-light fa-xmark"></i></button>
                                            <span class="badge bg-secondary p-1 rounded">Inbox</span>
                    ...
                    <div class="tab-pane fade" id="nav-important" role="tabpanel" aria-labelledby="nav-important-tab" tabindex="0">
                        <div class="panel-header">
                            <div class="d-flex align-items-center gap-1">
                                <button class="btn btn-sm btn-icon btn-primary mail-menu-btn d-lg-none"><i class="fa-light fa-bars"></i></button>
                                <h5>Important</h5>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-wrapper">
                                ...
                                <div class="mail-details d-none" data-mail-tab="nav-important">
                                    <div class="mail-body-top d-flex justify-content-between align-items-center mb-10">
                                        <div class="left d-flex align-items-center gap-2">
                                            <button class="btn btn-sm btn-icon btn-outline-danger close-mail"><i class="fa-light fa-xmark"></i></button>
                                            <span class="badge bg-secondary p-1 rounded">Inbox</span>
    ...
    <script src="/digiboard/assets/vendor/js/ckeditor.js"></script>
    <script src="/digiboard/assets/vendor/js/jquery.dataTables.min.js"></script>
    ...
    <script src="/digiboard/assets/js/email.js"></script>
    <script src="/digiboard/assets/js/select2-init.js"></script>
</body>
</html>