...
<head>
    ...
    <title>Messenger | Digiboard</title>
    ...
    <link rel="stylesheet" href="/digiboard/assets/vendor/css/owl.carousel.min.css">
...
<body class="body-padding body-p-top light-theme">
                        ...
                        <div class="active-members owl-carousel">
                            <div class="single-member">
                                <button class="btn-flush avatar">
                                    <img src="/digiboard/assets/images/avatar-2.png" alt="User">
                                    <span class="active-status active"></span>
                                </button>
                            </div>
                            <div class="single-member">
                                <button class="btn-flush avatar">
                                    <img src="/digiboard/assets/images/avatar-3.png" alt="User">
                                    <span class="active-status active"></span>
                                </button>
                            </div>
                            <div class="single-member">
                                <button class="btn-flush avatar">
                                    <img src="/digiboard/assets/images/avatar-4.png" alt="User">
                                    <span class="active-status active"></span>
                                </button>
                            </div>
                            <div class="single-member">
                                <button class="btn-flush avatar">
                                    <img src="/digiboard/assets/images/avatar-5.png" alt="User">
                                    <span class="active-status active"></span>
                                </button>
                            </div>
                            <div class="single-member">
                                <button class="btn-flush avatar">
                                    <img src="/digiboard/assets/images/avatar-6.png" alt="User">
                                    <span class="active-status active"></span>
                                </button>
                            </div>
                            <div class="single-member">
                                <button class="btn-flush avatar">
                                    <img src="/digiboard/assets/images/avatar.png" alt="User">
                                    <span class="active-status active"></span>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="video-call">
                        <div class="user">
                            <div class="user-preview">
                                <img src="/digiboard/assets/images/avatar-big.jpg" alt="User">
                            </div>
                            <div class="part-txt">
                                <span class="user-name">Amelie Harris</span>
                                <span class="call-status">Calling...</span>
                        ...
                        <div class="bottom">
                            ...
                            <div class="admin-preview">
                                <img src="/digiboard/assets/images/admin.png" alt="Admin">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="/digiboard/assets/vendor/js/owl.carousel.min.js"></script>
