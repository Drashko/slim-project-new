...
<head>
    ...
    <title>Target Audience | Digiboard</title>
            ...
            <div class="col-12">
                <div class="panel">
                                ...
                                <ul class="digi-dropdown-menu dropdown-menu">
                                    ...
                                    <li>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="showFirstName" checked>
                                    ...
                                    <li>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="showLastName" checked>
                                    ...
                                    <li>
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="showPosition">
                                                Position
                                            </label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="showLastLogin" checked>
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-dashed table-hover digi-dataTable target-audience-table table-striped" id="targetAudienceTable">
                            <thead>
                                <tr>
                                    <th class="no-sort">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="markAllAudience">
                                        </div>
                                    </th>
                                    <th>First Name</th>
                                    <th>Last Name</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Strongbod</td>
                                    <td>+1 23 456 789</td>
                                    <td>Printing machine operator</td>
                                    <td>2 Hrs Ago</td>
                                    <td>
