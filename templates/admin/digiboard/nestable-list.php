...
<head>
    ...
    <title>Nestable List | Digiboard</title>
...
<body class="body-padding body-p-top light-theme">
                ...
                <div class="header-right-btns d-flex justify-content-end align-items-center">
                                ...
                                <div class="header-btn-box">
                                    ...
                                    <ul class="message-dropdown dropdown-menu" aria-labelledby="messageDropdown">
                                        <li>
                                            <a href="#" class="d-flex">
                                                <div class="avatar">
                                                    <img src="/digiboard/assets/images/avatar.png" alt="image">
                                                </div>
                                                <div class="msg-txt">
                                        ...
                                        <li>
                                            <a href="#" class="d-flex">
                                                <div class="avatar">
                                                    <img src="/digiboard/assets/images/avatar-2.png" alt="image">
                                                </div>
                                                <div class="msg-txt">
                                        ...
                                        <li>
                                            <a href="#" class="d-flex">
                                                <div class="avatar">
                                                    <img src="/digiboard/assets/images/avatar-3.png" alt="image">
                                                </div>
                                                <div class="msg-txt">
                                ...
                                <div class="header-btn-box">
                                    ...
                                    <ul class="notification-dropdown dropdown-menu" aria-labelledby="notificationDropdown">
                                        ...
                                        <li>
                                            <a href="#" class="d-flex align-items-center">
                                                <div class="avatar">
                                                    <img src="/digiboard/assets/images/avatar-4.png" alt="image">
                                                </div>
                                                <div class="notification-txt">
                                        ...
                                        <li>
                                            <a href="#" class="d-flex align-items-center">
                                                <div class="avatar">
                                                    <img src="/digiboard/assets/images/avatar-5.png" alt="image">
                                                </div>
                                                <div class="notification-txt">
                                        ...
                                        <li>
                                            <a href="#" class="d-flex align-items-center">
                                                <div class="avatar">
                                                    <img src="/digiboard/assets/images/avatar-6.png" alt="image">
                                                </div>
                                                <div class="notification-txt">
                    ...
                    <div class="header-btn-box profile-btn-box">
                        <button class="profile-btn" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="/digiboard/assets/images/admin.png" alt="image">
                        </button>
            ...
            <div class="right-sidebar-group">
                ...
                <div>
                    <div class="sidebar-bg-btn-box">
                        ...
                        <button class="sidebar-bg-btn" data-img="/digiboard/assets/images/nav-bg-1.jpg"></button>
                        <button class="sidebar-bg-btn" data-img="/digiboard/assets/images/nav-bg-2.jpg"></button>
                        <button class="sidebar-bg-btn" data-img="/digiboard/assets/images/nav-bg-3.jpg"></button>
                        <button class="sidebar-bg-btn" data-img="/digiboard/assets/images/nav-bg-4.jpg"></button>
                    </div>
                </div>
            </div>
            <div class="right-sidebar-group">
                ...
                <div>
                    <div class="main-content-bg-btn-box">
                        ...
                        <button class="main-content-bg-btn" data-img="/digiboard/assets/images/main-bg-1.jpg"></button>
                        <button class="main-content-bg-btn" data-img="/digiboard/assets/images/main-bg-2.jpg"></button>
                        <button class="main-content-bg-btn" data-img="/digiboard/assets/images/main-bg-3.jpg"></button>
                        <button class="main-content-bg-btn" data-img="/digiboard/assets/images/main-bg-4.jpg"></button>
                    </div>
                </div>
            </div>
            <div class="right-sidebar-group">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <p class="fs-14 pb-1 mb-10">Use <code>nested-sortable</code> class to list-group class to set a nested list with sortable items.</p>
                        <div id="nestableList" class="list-group nested-sortable">
                            ...
                            <div class="list-group-item">Item 1.2
                                <div class="list-group nested-sortable">
                                    <div class="list-group-item">Item 2.1</div>
                            ...
                            <div class="list-group-item">Item 1.3
                                <div class="list-group nested-sortable">
            ...
            <div class="col-md-6">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <p class="fs-14 pb-1 mb-10">Use <code>nested-sortable-handle</code> class to list-group class to set a nested list with sortable items.</p>
                        <div id="nestableListWithHandle" class="list-group nested-sortable-handle">
                            <div class="list-group-item"><span class="handle"><i class="fa-light fa-bars"></i></span> Item 1.1
                                <div class="list-group nested-sortable-handle">
                                    <div class="list-group-item"><span class="handle"><i class="fa-light fa-bars"></i></span> Item 2.1</div>
                                    <div class="list-group-item"><span class="handle"><i class="fa-light fa-bars"></i></span> Item 2.3</div>
                                </div>
                            </div>
                            <div class="list-group-item"><span class="handle"><i class="fa-light fa-bars"></i></span> Item 1.2
                                <div class="list-group nested-sortable-handle">
                                    <div class="list-group-item"><span class="handle"><i class="fa-light fa-bars"></i></span> Item 2.1</div>
                                    <div class="list-group-item"><span class="handle"><i class="fa-light fa-bars"></i></span> Item 2.2</div>
                                    <div class="list-group-item"><span class="handle"><i class="fa-light fa-bars"></i></span> Item 2.3</div>
                                </div>
                            </div>
                            <div class="list-group-item"><span class="handle"><i class="fa-light fa-bars"></i></span> Item 1.3
                                <div class="list-group nested-sortable-handle">
                                    <div class="list-group-item nested-3"><span class="handle"><i class="fa-light fa-bars"></i></span> Item 3.1</div>
                                    <div class="list-group-item nested-3"><span class="handle"><i class="fa-light fa-bars"></i></span> Item 3.2</div>
                                    <div class="list-group-item nested-3"><span class="handle"><i class="fa-light fa-bars"></i></span> Item 3.3</div>
                                </div>
                            </div>
                            <div class="list-group-item"><span class="handle"><i class="fa-light fa-bars"></i></span> Item 1.4</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <p class="fs-14 pb-1 mb-10">Use <code>nested-sortable</code> class to list-group class to set a nested list with sortable items where icons are given within list-group-item.</p>
                        <div id="nestableList2" class="list-group nested-sortable">
                            <div class="list-group-item"><span class="text-warning"><i class="fa-solid fa-folder-open"></i></span> css
                                <div class="list-group nested-sortable">
                                    <div class="list-group-item"><span class="text-primary"><i class="fa-brands fa-css3"></i></span> style.css</div>
                                    <div class="list-group-item"><span class="text-primary"><i class="fa-brands fa-css3"></i></span> style.min.css</div>
                                </div>
                            </div>
                            <div class="list-group-item"><span class="text-warning"><i class="fa-solid fa-folder-open"></i></span> images
                                <div class="list-group nested-sortable">
                                    <div class="list-group-item"><span class="text-info"><i class="fa-regular fa-image"></i></span> logo.png</div>
                                    <div class="list-group-item"><span class="text-info"><i class="fa-regular fa-image"></i></span> avatar.png</div>
                                    <div class="list-group-item"><span class="text-info"><i class="fa-regular fa-image"></i></span> product.jpg</div>
                                </div>
                            </div>
                            <div class="list-group-item"><span class="text-warning"><i class="fa-solid fa-folder-open"></i></span> js
                                <div class="list-group nested-sortable">
                                    <div class="list-group-item nested-3"><span class="text-warning"><i class="fa-brands fa-square-js"></i></span> main.js</div>
                                    <div class="list-group-item nested-3"><span class="text-warning"><i class="fa-brands fa-square-js"></i></span> main.min.js</div>
                                    <div class="list-group-item nested-3"><span class="text-warning"><i class="fa-brands fa-square-js"></i></span> plugin.js</div>
                                </div>
                            </div>
                            <div class="list-group-item"><span class="text-danger"><i class="fa-brands fa-html5"></i></span> index.html</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <p class="fs-14 pb-1 mb-10">Use <code>nested-sortable</code> class to list-group class to set a nested list with sortable items where images are attached within a list-group-item div element.</p>
                        <div id="nestableList3" class="list-group nested-sortable">
                            <div class="list-group-item">
                                <span class="team-list">
                                    <span class="avatar"><img src="/digiboard/assets/images/admin.png" alt="Image"></span>
                                    <span class="part-txt">
                                        <span class="name">Shaikh Abu Dardah</span>
                                ...
                                <div class="list-group nested-sortable">
                                    <div class="list-group-item">
                                        <span class="team-list">
                                            <span class="avatar"><img src="/digiboard/assets/images/avatar-2.png" alt="Image"></span>
                                            <span class="part-txt">
                                                <span class="name">Leo Sims</span>
                                        ...
                                        <div class="list-group nested-sortable">
                                            <div class="list-group-item">
                                                <span class="team-list">
                                                    <span class="avatar"><img src="/digiboard/assets/images/avatar-4.png" alt="Image"></span>
                                                    <span class="part-txt">
                                                        <span class="name">Jasmine Fletcher</span>
                                            ...
                                            <div class="list-group-item">
                                                <span class="team-list">
                                                    <span class="avatar"><img src="/digiboard/assets/images/avatar-5.png" alt="Image"></span>
                                                    <span class="part-txt">
                                                        <span class="name">Lilly Ford</span>
                                                        <span class="position">UI/UX Designer</span>
                                                    </span>
                                                </span>
                                            </div>
                                            <div class="list-group-item">
                                                <span class="team-list">
                                                    <span class="avatar"><img src="/digiboard/assets/images/avatar-6.png" alt="Image"></span>
                                                    <span class="part-txt">
                                                        <span class="name">Dylan Parkin</span>
                                            ...
                                            <div class="list-group-item">
                                                <span class="team-list">
                                                    <span class="avatar"><img src="/digiboard/assets/images/avatar-3.png" alt="Image"></span>
                                                    <span class="part-txt">
                                                        <span class="name">Megan Hawkins</span>
                                                        <span class="position">Front End Developer</span>
                                                    </span>
                                                </span>
                                            </div>
                                    ...
                                    <div class="list-group-item">
                                        <span class="team-list">
                                            <span class="avatar"><img src="/digiboard/assets/images/avatar-3.png" alt="Image"></span>
                                            <span class="part-txt">
                                                <span class="name">Naomi Jennings</span>
                                                <span class="position">Project Manager</span>
                                            </span>
                                        </span>
                                        <div class="list-group nested-sortable">
                                            <div class="list-group-item nested-3">
                                                <span class="team-list">
                                                    <span class="avatar"><img src="/digiboard/assets/images/avatar-2.png" alt="Image"></span>
                                                    <span class="part-txt">
                                                        <span class="name">Michael Morgan</span>
                                                        <span class="position">Laravel Developer</span>
                                                    </span>
                                                </span>
                                            </div>
                                            <div class="list-group-item nested-3">
                                                <span class="team-list">
                                                    <span class="avatar"><img src="/digiboard/assets/images/avatar-4.png" alt="Image"></span>
                                                    <span class="part-txt">
                                                        <span class="name">Ryan Chapman</span>
                                            ...
                                            <div class="list-group-item nested-3">
                                                <span class="team-list">
                                                    <span class="avatar"><img src="/digiboard/assets/images/avatar-5.png" alt="Image"></span>
                                                    <span class="part-txt">
                                                        <span class="name">Hayden Bull</span>
                                                        <span class="position">Wordpress Developer</span>
                                                    </span>
                                                </span>
                                            </div>
                                        </div>
    ...
    <script src="/digiboard/assets/vendor/js/jquery.overlayScrollbars.min.js"></script>
    <script src="/digiboard/assets/vendor/js/Sortable.js"></script>
    <script src="/digiboard/assets/vendor/js/bootstrap.bundle.min.js"></script>
    <script src="/digiboard/assets/js/main.js"></script>
    <script src="/digiboard/assets/js/sortable-js-init.js"></script>
</body>
