...
<head>
    ...
    <title>Calendar | Digiboard</title>
    ...
    <link rel="stylesheet" href="/digiboard/assets/vendor/css/fullCalendar/main.min.css">
    <link rel="stylesheet" href="/digiboard/assets/vendor/css/fullCalendar/daygrid.min.css">
    <link rel="stylesheet" href="/digiboard/assets/vendor/css/fullCalendar/timegrid.min.css">
...
<body class="body-padding body-p-top light-theme">
    ...
    <script src="/digiboard/assets/vendor/js/fullCalendar/main.min.js"></script>
    <script src="/digiboard/assets/vendor/js/fullCalendar/interaction.min.js"></script>
    <script src="/digiboard/assets/vendor/js/fullCalendar/daygrid.min.js"></script>
    <script src="/digiboard/assets/vendor/js/fullCalendar/timegrid.min.js"></script>
    <script src="/digiboard/assets/vendor/js/bootstrap.bundle.min.js"></script>
    <script src="/digiboard/assets/js/main.js"></script>
    <script src="/digiboard/assets/js/calendar-init.js"></script>
</body>
</html>