...
<head>
    ...
    <title>Welcome to Digiboard</title>
...
<body class="light-theme">
    ...
    <!-- main content start -->
    <div class="main-content login-panel welcome-panel">
            ...
            <div class="panel bg-transparent">
                <div class="panel-body">
                    ...
                    <div class="part-txt text-center">
                        ...
                        <a href="index.html" class="btn btn-primary px-3">Go To Dashboard</a>
                    </div>
                    <div class="part-img w-50 m-auto">
                        <img src="/digiboard/assets/images/welcome-img.png" alt="image">
                    </div>
                </div>
            </div>
        </div>
