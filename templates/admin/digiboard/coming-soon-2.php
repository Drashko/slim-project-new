...
<body class="light-theme">
    ...
    <div class="main-content p-0">
        <div class="panel coming-soon-panel coming-soon-panel-2">
            <div class="panel-body h-100 d-flex flex-column align-items-center justify-content-center">
                <div class="part-img">
                    <img src="/digiboard/assets/images/coming-soon-2.png" alt="coming-soon">
                </div>
                <div class="part-txt">
                    <ul class="countdown">
                    ...
                    <a href="index.html" class="btn btn-primary py-2 px-5 rounded-pill">Go To Home</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="/digiboard/assets/vendor/js/jquery.countdown.min.js"></script>
    <script src="/digiboard/assets/js/main.js"></script>
    <script src="/digiboard/assets/js/countdown.js"></script>
</body>
