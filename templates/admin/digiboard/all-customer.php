...
<head>
    ...
    <title>Customer List | Digiboard</title>
...
<body class="body-padding body-p-top light-theme">
    ...
    <script src="/digiboard/assets/vendor/js/pdfmake.min.js"></script>
    <script src="/digiboard/assets/vendor/js/html2canvas.min.js"></script>
    <script src="/digiboard/assets/vendor/js/jquery.table2excel.min.js"></script>
    ...
    <script src="/digiboard/assets/js/order-list.js"></script>
</body>
</html>