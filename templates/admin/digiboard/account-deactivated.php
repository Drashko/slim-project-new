...
<head>
    ...
    <title>Account Deactivated | Digiboard</title>
            ...
            <div class="panel bg-transparent">
                <div class="panel-body">
                    ...
                    <div class="part-txt text-center">
                        ...
                        <a href="index.html" class="btn btn-primary px-3">Go To Home Page</a>
                    </div>
                    <div class="part-img w-50 m-auto">
                        <img src="/digiboard/assets/images/deactivated-img.png" alt="image">
                    </div>
                </div>
            </div>
        </div>
