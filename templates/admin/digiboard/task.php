                        ...
                        <table class="table table-dashed table-hover digi-dataTable task-table table-striped" id="taskTable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a role="button" class="text-decoration-underline" data-bs-toggle="modal" data-bs-target="#viewTaskModal">Web Design & Development</a></td>
                                    <td>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" id="addTaskEndDate" class="form-control form-control-sm date-picker" placeholder="Eg: 12 Feb, 20" readonly>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            ...
                            <select class="form-control form-control-sm select-multiple" data-placeholder="Eg: Natasha Hancock" multiple>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" id="editTaskStartDate" class="form-control form-control-sm date-picker" placeholder="Eg: 12 Feb, 20" value="12 Feb, 23" readonly>
                        </div>
                        <div class="col-sm-6">
                            <label for="editTaskEndDate" class="form-label">End Date</label>
                            <input type="text" id="editTaskEndDate" class="form-control form-control-sm date-picker" placeholder="Eg: 12 Feb, 20" value="12 Mar, 23" readonly>
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label">Priority</label>
                            <select class="form-control form-control-sm" data-placeholder="Select Priority">
                ...
                <div class="modal-body view-task">
                    <div class="row g-3">
                        <div class="col-lg-8 col-md-7">
                            <span class="task-created"><i class="fa-light fa-clock"></i> Created at 16/02/2023 03:20:50 by <a href="view-profile.html">Admin</a></span>
                            <div class="task-dscr">
                                ...
                                <div class="task-attachment">
                                    <div class="attched-box">
                                        <img src="/digiboard/assets/images/product-img-1.jpg" alt="Image">
                                    </div>
