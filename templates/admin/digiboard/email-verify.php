...
<head>
    ...
    <title>Email Verification | Digiboard</title>
...
<body class="light-theme">
    ...
    <!-- main content start -->
    <div class="main-content login-panel email-verify-panel">
            ...
            <div class="panel bg-transparent">
                <div class="panel-body">
                    ...
                    <div class="part-txt text-center">
                        ...
                        <a href="index.html" class="btn btn-primary px-3">Click To Verify</a>
                    </div>
                    <div class="part-img w-75 m-auto">
                        <img src="/digiboard/assets/images/verify-email.png" alt="image">
                    </div>
                </div>
            </div>
        </div>
