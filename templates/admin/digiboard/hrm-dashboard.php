...
<head>
    ...
    <title>HR Dashboard | Digiboard</title>
...
<body class="body-padding body-p-top light-theme">
                        ...
                        <ul class="upcoming-interview">
                            <li>
                                <div class="avatar avatar-lg">
                                    <img src="/digiboard/assets/images/avatar-2.png" class="rounded" alt="user">
                                </div>
                                <div class="part-txt">
                            ...
                            <li>
                                <div class="avatar avatar-lg">
                                    <img src="/digiboard/assets/images/avatar-3.png" class="rounded" alt="user">
                                </div>
                                <div class="part-txt">
                                    <span class="applicant-name">Natalie Gibson</span>
                                    <span class="applicant-role">
                            ...
                            <li>
                                <div class="avatar avatar-lg">
                                    <img src="/digiboard/assets/images/avatar-4.png" class="rounded" alt="user">
                                </div>
                                <div class="part-txt">
                                    <span class="applicant-name">Natalie Gibson</span>
                                    <span class="applicant-role">
                            ...
                            <li>
                                <div class="avatar avatar-lg">
                                    <img src="/digiboard/assets/images/avatar-5.png" class="rounded" alt="user">
                                </div>
                                <div class="part-txt">
                                    <span class="applicant-name">Natalie Gibson</span>
                                    <span class="applicant-role">
                            ...
                            <li>
                                <div class="avatar avatar-lg">
                                    <img src="/digiboard/assets/images/avatar-6.png" class="rounded" alt="user">
                                </div>
                                <div class="part-txt">
                                    <span class="applicant-name">Natalie Gibson</span>
                                    <span class="applicant-role">
    ...
    <script src="/digiboard/assets/js/dashboard.js"></script>
