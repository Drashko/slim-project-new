...
<head>
    ...
    <title>Attendance | Digiboard</title>
            ...
            <div class="col-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="row g-3">
                                <div class="col-sm-10 col-9 col-xs-12">
                                    <div class="row g-3">
                                        ...
                                        <div class="col">
                                            <select class="form-control form-control-sm select-search" data-placeholder="Select Employee">
                        ...
                        <table class="table table-dashed table-hover digi-dataTable attendance-table table-striped" id="attendanceTable">
                            <thead>
                                <tr>
                                    <th class="no-sort">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="markAllAttendance">
                                        </div>
                                    </th>
                                    <th>Date</th>
                                    <th>Name</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="badge bg-success rounded">On Time</span></td>
                                    <td>B</td>
                                    <td>
                                        <div class="btn-box">
                                            <button class="btn btn-sm btn-icon btn-primary"><i class="fa-light fa-edit"></i></button>
