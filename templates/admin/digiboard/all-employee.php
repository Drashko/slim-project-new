...
<head>
    ...
    <title>All Employee | Digiboard</title>
                ...
                <div class="panel">
                    <div class="panel-header">
                        ...
                        <div class="btn-box d-flex flex-wrap gap-2">
                            ...
                            <a href="add-employee.html" class="btn btn-sm btn-primary"><i class="fa-light fa-plus"></i> Add New</a>
                        </div>
                    </div>
                        ...
                        <table class="table table-dashed table-hover digi-dataTable all-employee-table table-striped" id="allEmployeeTable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>+1 234 567 890</td>
                                    <td>
                                        <span class="address-txt">75 York Road OUTGATE LA22 6HL</span>
                                    </td>
